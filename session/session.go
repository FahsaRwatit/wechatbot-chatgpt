...
var ProxyServer string = "127.0.0.1:33210"

// var ProxyServer string = "216.48.190.84:3127"
...
func launchBrowser(pw *playwright.Playwright, url string, headless bool) (playwright.BrowserContext, playwright.Page, error) {
	...
	browser, err := pw.Chromium.LaunchPersistentContext("/tmp/chatgpt", playwright.BrowserTypeLaunchPersistentContextOptions{
		Headless: playwright.Bool(headless),
		Proxy:    &playwright.BrowserTypeLaunchPersistentContextOptionsProxy{Server: &ProxyServer},
	})
...
func logIn(pw *playwright.Playwright) <-chan Result {
	...
	go func() {
		...
		log.Println("Please login to OpenAI Chat")
